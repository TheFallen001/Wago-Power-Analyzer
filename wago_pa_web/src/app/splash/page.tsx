...
export default function Splash() {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      router.push("/add-pa"); // Redirect to main page after splash
    }, 1500);
    return () => clearTimeout(timer);
  }, [router]);

  return (
    <div style={{ background: '#0057B8', minHeight: '100vh' }} className="flex flex-col items-center justify-center">
      ...
      <div style={{ background: '#fff' }} className="w-24 h-24 rounded-full flex items-center justify-center">
        <span style={{ color: '#0057B8' }} className="text-3xl font-bold">W</span>
      </div>
