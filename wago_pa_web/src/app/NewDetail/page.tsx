        ...
        <div className="bg-white rounded-xl shadow p-4 flex flex-col">
          ...
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-medium text-gray-600">{mockSiteInfo.weather}</span>
          ...
          <div className="text-sm mb-1 text-gray-500">{mockSiteInfo.name}</div>
          <div className="text-xs text-gray-500 font-bold">TOTAL AREA</div>
          <div className="text-sm mb-1 text-gray-500">{mockSiteInfo.area}</div>
          <div className="text-xs text-gray-500 font-bold">INSTALLED POWER</div>
          <div className="text-sm mb-1 text-gray-500">{mockSiteInfo.power}</div>
