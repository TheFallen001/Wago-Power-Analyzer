...
class ResourceUsage {
    constructor(rss, free_memory, total_memory, available_memory, maxRss, constrained_memory, userCpuSeconds, kernelCpuSeconds, cpuConsumptionPercent, userCpuConsumptionPercent, kernelCpuConsumptionPercent, pageFaults, fsActivity) {
        this.rss = rss;
