[@wago/wdx-schema-base](../README.md) / [Exports](../modules.md) / [WDX](../modules/WDX.md) / [Schema](../modules/WDX.Schema.md) / [Message](../modules/WDX.Schema.Message.md) / [Script](../modules/WDX.Schema.Message.Script.md) / SaveRequest
...
- [timezone](WDX.Schema.Message.Script.SaveRequest.md#timezone)
...
• **new SaveRequest**(`body?`, `uuid?`, `error?`, `topic?`, `target?`, `origin?`, `timezone?`): [`SaveRequest`](WDX.Schema.Message.Script.SaveRequest.md)
...
src/WDX/Schema/Message/Script/SaveRequest.ts:16
...
src/WDX/Schema/Message/Script/SaveRequest.ts:14
