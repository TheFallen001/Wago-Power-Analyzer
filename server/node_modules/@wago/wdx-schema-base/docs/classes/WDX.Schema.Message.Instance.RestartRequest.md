[@wago/wdx-schema-base](../README.md) / [Exports](../modules.md) / [WDX](../modules/WDX.md) / [Schema](../modules/WDX.Schema.md) / [Message](../modules/WDX.Schema.Message.md) / [Instance](../modules/WDX.Schema.Message.Instance.md) / RestartRequest
...
- [timezone](WDX.Schema.Message.Instance.RestartRequest.md#timezone)
...
• **new RestartRequest**(`body?`, `uuid?`, `error?`, `topic?`, `target?`, `origin?`, `timezone?`): [`RestartRequest`](WDX.Schema.Message.Instance.RestartRequest.md)
...
src/WDX/Schema/Message/Instance/RestartRequest.ts:19
...
src/WDX/Schema/Message/Instance/RestartRequest.ts:14
