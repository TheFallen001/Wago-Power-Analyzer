[@wago/wdx-schema-base](../README.md) / [Exports](../modules.md) / [WDX](../modules/WDX.md) / [Schema](../modules/WDX.Schema.md) / [Message](../modules/WDX.Schema.Message.md) / [Alarm](../modules/WDX.Schema.Message.Alarm.md) / ListHistoryRequest
...
- [timezone](WDX.Schema.Message.Alarm.ListHistoryRequest.md#timezone)
...
• **new ListHistoryRequest**(`body?`, `uuid?`, `error?`, `topic?`, `target?`, `origin?`, `timezone?`): [`ListHistoryRequest`](WDX.Schema.Message.Alarm.ListHistoryRequest.md)
...
src/WDX/Schema/Message/Alarm/ListHistoryRequest.ts:13
...
src/WDX/Schema/Message/Alarm/ListHistoryRequest.ts:11
