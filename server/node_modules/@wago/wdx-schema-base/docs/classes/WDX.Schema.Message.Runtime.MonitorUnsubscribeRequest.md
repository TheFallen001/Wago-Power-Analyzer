[@wago/wdx-schema-base](../README.md) / [Exports](../modules.md) / [WDX](../modules/WDX.md) / [Schema](../modules/WDX.Schema.md) / [Message](../modules/WDX.Schema.Message.md) / [Runtime](../modules/WDX.Schema.Message.Runtime.md) / MonitorUnsubscribeRequest
...
- [timezone](WDX.Schema.Message.Runtime.MonitorUnsubscribeRequest.md#timezone)
...
• **new MonitorUnsubscribeRequest**(`body?`, `uuid?`, `error?`, `topic?`, `target?`, `origin?`, `timezone?`): [`MonitorUnsubscribeRequest`](WDX.Schema.Message.Runtime.MonitorUnsubscribeRequest.md)
...
src/WDX/Schema/Message/Runtime/MonitorUnsubscribeRequest.ts:15
...
src/WDX/Schema/Message/Runtime/MonitorUnsubscribeRequest.ts:14
