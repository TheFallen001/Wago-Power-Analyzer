[@wago/wdx-schema-base](../README.md) / [Exports](../modules.md) / [WDX](../modules/WDX.md) / [Schema](../modules/WDX.Schema.md) / [Message](../modules/WDX.Schema.Message.md) / [Trend](../modules/WDX.Schema.Message.Trend.md) / DetailResponse
...
- [timezone](WDX.Schema.Message.Trend.DetailResponse.md#timezone)
...
• **new DetailResponse**(`body?`, `uuid?`, `error?`, `topic?`, `target?`, `origin?`, `timezone?`): [`DetailResponse`](WDX.Schema.Message.Trend.DetailResponse.md)
...
src/WDX/Schema/Message/Trend/DetailResponse.ts:14
...
src/WDX/Schema/Message/Trend/DetailResponse.ts:12
