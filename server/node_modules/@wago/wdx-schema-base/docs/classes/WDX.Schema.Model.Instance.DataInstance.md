[@wago/wdx-schema-base](../README.md) / [Exports](../modules.md) / [WDX](../modules/WDX.md) / [Schema](../modules/WDX.Schema.md) / [Model](../modules/WDX.Schema.Model.md) / [Instance](../modules/WDX.Schema.Model.Instance.md) / DataInstance
...
- [id](WDX.Schema.Model.Instance.DataInstance.md#id)
- [ipcType](WDX.Schema.Model.Instance.DataInstance.md#ipctype)
...
- [needsRestart](WDX.Schema.Model.Instance.DataInstance.md#needsrestart)
- [order](WDX.Schema.Model.Instance.DataInstance.md#order)
...
- [startTime](WDX.Schema.Model.Instance.DataInstance.md#starttime)
- [status](WDX.Schema.Model.Instance.DataInstance.md#status)
- [stopTime](WDX.Schema.Model.Instance.DataInstance.md#stoptime)
...
- [type](WDX.Schema.Model.Instance.DataInstance.md#type)
...
• **new DataInstance**(): [`DataInstance`](WDX.Schema.Model.Instance.DataInstance.md)
...
src/WDX/Schema/Model/Instance/DataInstance.ts:19
...
src/WDX/Schema/Model/Instance/DataInstance.ts:17
...
• **type**: [`Type`](../enums/WDX.Schema.Model.Instance.Type.md) = `Type.Data`
...
src/WDX/Schema/Model/Instance/DataInstance.ts:15
