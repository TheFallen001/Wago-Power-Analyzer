[@wago/wdx-schema-base](../README.md) / [Exports](../modules.md) / [WDX](../modules/WDX.md) / [Schema](../modules/WDX.Schema.md) / [Message](../modules/WDX.Schema.Message.md) / [Data](../modules/WDX.Schema.Message.Data.md) / RegisterSchemaChangesResponse
...
- [timezone](WDX.Schema.Message.Data.RegisterSchemaChangesResponse.md#timezone)
...
• **new RegisterSchemaChangesResponse**(`body?`, `uuid?`, `error?`, `topic?`, `target?`, `origin?`, `timezone?`): [`RegisterSchemaChangesResponse`](WDX.Schema.Message.Data.RegisterSchemaChangesResponse.md)
...
src/WDX/Schema/Message/Data/RegisterSchemaChangesResponse.ts:15
...
src/WDX/Schema/Message/Data/RegisterSchemaChangesResponse.ts:14
