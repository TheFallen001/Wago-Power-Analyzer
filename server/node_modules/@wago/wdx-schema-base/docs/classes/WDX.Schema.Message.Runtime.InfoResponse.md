[@wago/wdx-schema-base](../README.md) / [Exports](../modules.md) / [WDX](../modules/WDX.md) / [Schema](../modules/WDX.Schema.md) / [Message](../modules/WDX.Schema.Message.md) / [Runtime](../modules/WDX.Schema.Message.Runtime.md) / InfoResponse
...
- [timezone](WDX.Schema.Message.Runtime.InfoResponse.md#timezone)
...
• **new InfoResponse**(`body?`, `uuid?`, `error?`, `topic?`, `target?`, `origin?`, `timezone?`): [`InfoResponse`](WDX.Schema.Message.Runtime.InfoResponse.md)
...
src/WDX/Schema/Message/Runtime/InfoResponse.ts:19
...
src/WDX/Schema/Message/Runtime/InfoResponse.ts:18
