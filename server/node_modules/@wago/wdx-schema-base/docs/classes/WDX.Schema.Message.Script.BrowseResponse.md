[@wago/wdx-schema-base](../README.md) / [Exports](../modules.md) / [WDX](../modules/WDX.md) / [Schema](../modules/WDX.Schema.md) / [Message](../modules/WDX.Schema.Message.md) / [Script](../modules/WDX.Schema.Message.Script.md) / BrowseResponse
...
- [timezone](WDX.Schema.Message.Script.BrowseResponse.md#timezone)
...
• **new BrowseResponse**(`body?`, `uuid?`, `error?`, `topic?`, `target?`, `origin?`, `timezone?`): [`BrowseResponse`](WDX.Schema.Message.Script.BrowseResponse.md)
...
src/WDX/Schema/Message/Script/BrowseResponse.ts:17
...
src/WDX/Schema/Message/Script/BrowseResponse.ts:15
