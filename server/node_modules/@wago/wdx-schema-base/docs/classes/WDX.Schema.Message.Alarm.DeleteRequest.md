[@wago/wdx-schema-base](../README.md) / [Exports](../modules.md) / [WDX](../modules/WDX.md) / [Schema](../modules/WDX.Schema.md) / [Message](../modules/WDX.Schema.Message.md) / [Alarm](../modules/WDX.Schema.Message.Alarm.md) / DeleteRequest
...
- [timezone](WDX.Schema.Message.Alarm.DeleteRequest.md#timezone)
...
• **new DeleteRequest**(`body?`, `uuid?`, `error?`, `topic?`, `target?`, `origin?`, `timezone?`): [`DeleteRequest`](WDX.Schema.Message.Alarm.DeleteRequest.md)
...
src/WDX/Schema/Message/Alarm/DeleteRequest.ts:18
...
src/WDX/Schema/Message/Alarm/DeleteRequest.ts:13
