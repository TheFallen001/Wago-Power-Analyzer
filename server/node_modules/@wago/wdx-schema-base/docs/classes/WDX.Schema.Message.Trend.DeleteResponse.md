[@wago/wdx-schema-base](../README.md) / [Exports](../modules.md) / [WDX](../modules/WDX.md) / [Schema](../modules/WDX.Schema.md) / [Message](../modules/WDX.Schema.Message.md) / [Trend](../modules/WDX.Schema.Message.Trend.md) / DeleteResponse
...
- [timezone](WDX.Schema.Message.Trend.DeleteResponse.md#timezone)
...
• **new DeleteResponse**(`body?`, `uuid?`, `error?`, `topic?`, `target?`, `origin?`, `timezone?`): [`DeleteResponse`](WDX.Schema.Message.Trend.DeleteResponse.md)
...
src/WDX/Schema/Message/Trend/DeleteResponse.ts:14
...
src/WDX/Schema/Message/Trend/DeleteResponse.ts:12
