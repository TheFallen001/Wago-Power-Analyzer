[@wago/wdx-schema-base](../README.md) / [Exports](../modules.md) / [WDX](../modules/WDX.md) / [Schema](../modules/WDX.Schema.md) / [Message](../modules/WDX.Schema.Message.md) / [Instance](../modules/WDX.Schema.Message.Instance.md) / LogSubscribeResponseMessage
...
- [timezone](WDX.Schema.Message.Instance.LogSubscribeResponseMessage.md#timezone)
...
• **new LogSubscribeResponseMessage**(`body?`, `uuid?`, `error?`, `topic?`, `target?`, `origin?`, `timezone?`): [`LogSubscribeResponseMessage`](WDX.Schema.Message.Instance.LogSubscribeResponseMessage.md)
...
src/WDX/Schema/Message/Instance/LogSubscribeResponseMessage.ts:16
...
src/WDX/Schema/Message/Instance/LogSubscribeResponseMessage.ts:14
