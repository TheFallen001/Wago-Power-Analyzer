[@wago/wdx-schema-base](../README.md) / [Exports](../modules.md) / [WDX](../modules/WDX.md) / [Schema](../modules/WDX.Schema.md) / [Message](../modules/WDX.Schema.Message.md) / [Instance](../modules/WDX.Schema.Message.Instance.md) / SaveRequest
...
- [timezone](WDX.Schema.Message.Instance.SaveRequest.md#timezone)
...
• **new SaveRequest**(`body?`, `uuid?`, `error?`, `topic?`, `target?`, `origin?`, `timezone?`): [`SaveRequest`](WDX.Schema.Message.Instance.SaveRequest.md)
...
src/WDX/Schema/Message/Instance/SaveRequest.ts:17
...
src/WDX/Schema/Message/Instance/SaveRequest.ts:16
