[@wago/wdx-schema-base](../README.md) / [Exports](../modules.md) / [WDX](../modules/WDX.md) / [Schema](../modules/WDX.Schema.md) / [Message](../modules/WDX.Schema.Message.md) / [Script](../modules/WDX.Schema.Message.Script.md) / DeleteRequest
...
- [timezone](WDX.Schema.Message.Script.DeleteRequest.md#timezone)
...
• **new DeleteRequest**(`body?`, `uuid?`, `error?`, `topic?`, `target?`, `origin?`, `timezone?`): [`DeleteRequest`](WDX.Schema.Message.Script.DeleteRequest.md)
...
src/WDX/Schema/Message/Script/DeleteRequest.ts:16
...
src/WDX/Schema/Message/Script/DeleteRequest.ts:14
