[@wago/wdx-schema-base](../README.md) / [Exports](../modules.md) / [WDX](../modules/WDX.md) / [Schema](../modules/WDX.Schema.md) / [Message](../modules/WDX.Schema.Message.md) / [Instance](../modules/WDX.Schema.Message.Instance.md) / DeleteRequest
...
- [timezone](WDX.Schema.Message.Instance.DeleteRequest.md#timezone)
...
• **new DeleteRequest**(`body?`, `uuid?`, `error?`, `topic?`, `target?`, `origin?`, `timezone?`): [`DeleteRequest`](WDX.Schema.Message.Instance.DeleteRequest.md)
...
src/WDX/Schema/Message/Instance/DeleteRequest.ts:19
...
src/WDX/Schema/Message/Instance/DeleteRequest.ts:14
