[@wago/wdx-schema-base](../README.md) / [Exports](../modules.md) / [WDX](../modules/WDX.md) / [Schema](../modules/WDX.Schema.md) / [Message](../modules/WDX.Schema.Message.md) / [Alarm](../modules/WDX.Schema.Message.Alarm.md) / SetResponse
...
- [timezone](WDX.Schema.Message.Alarm.SetResponse.md#timezone)
...
• **new SetResponse**(`body?`, `uuid?`, `error?`, `topic?`, `target?`, `origin?`, `timezone?`): [`SetResponse`](WDX.Schema.Message.Alarm.SetResponse.md)
...
src/WDX/Schema/Message/Alarm/SetResponse.ts:16
...
src/WDX/Schema/Message/Alarm/SetResponse.ts:14
