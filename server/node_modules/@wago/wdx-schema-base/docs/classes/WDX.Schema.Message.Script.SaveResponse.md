[@wago/wdx-schema-base](../README.md) / [Exports](../modules.md) / [WDX](../modules/WDX.md) / [Schema](../modules/WDX.Schema.md) / [Message](../modules/WDX.Schema.Message.md) / [Script](../modules/WDX.Schema.Message.Script.md) / SaveResponse
...
- [timezone](WDX.Schema.Message.Script.SaveResponse.md#timezone)
...
• **new SaveResponse**(`body?`, `uuid?`, `error?`, `topic?`, `target?`, `origin?`, `timezone?`): [`SaveResponse`](WDX.Schema.Message.Script.SaveResponse.md)
...
src/WDX/Schema/Message/Script/SaveResponse.ts:17
...
src/WDX/Schema/Message/Script/SaveResponse.ts:15
