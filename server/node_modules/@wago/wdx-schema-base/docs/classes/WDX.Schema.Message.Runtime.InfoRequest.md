[@wago/wdx-schema-base](../README.md) / [Exports](../modules.md) / [WDX](../modules/WDX.md) / [Schema](../modules/WDX.Schema.md) / [Message](../modules/WDX.Schema.Message.md) / [Runtime](../modules/WDX.Schema.Message.Runtime.md) / InfoRequest
...
- [timezone](WDX.Schema.Message.Runtime.InfoRequest.md#timezone)
...
• **new InfoRequest**(`body?`, `uuid?`, `error?`, `topic?`, `target?`, `origin?`, `timezone?`): [`InfoRequest`](WDX.Schema.Message.Runtime.InfoRequest.md)
...
src/WDX/Schema/Message/Runtime/InfoRequest.ts:18
...
src/WDX/Schema/Message/Runtime/InfoRequest.ts:17
