[@wago/wdx-schema-base](../README.md) / [Exports](../modules.md) / [WDX](../modules/WDX.md) / [Schema](../modules/WDX.Schema.md) / [Model](../modules/WDX.Schema.Model.md) / [Instance](../modules/WDX.Schema.Model.Instance.md) / APIServerInstance
...
- [apiServerOptions](WDX.Schema.Model.Instance.APIServerInstance.md#apiserveroptions)
...
- [id](WDX.Schema.Model.Instance.APIServerInstance.md#id)
- [ipcType](WDX.Schema.Model.Instance.APIServerInstance.md#ipctype)
...
- [needsRestart](WDX.Schema.Model.Instance.APIServerInstance.md#needsrestart)
- [order](WDX.Schema.Model.Instance.APIServerInstance.md#order)
...
- [startTime](WDX.Schema.Model.Instance.APIServerInstance.md#starttime)
- [status](WDX.Schema.Model.Instance.APIServerInstance.md#status)
- [stopTime](WDX.Schema.Model.Instance.APIServerInstance.md#stoptime)
...
- [type](WDX.Schema.Model.Instance.APIServerInstance.md#type)
...
• **new APIServerInstance**(): [`APIServerInstance`](WDX.Schema.Model.Instance.APIServerInstance.md)
...
• **apiServerOptions**: [`APIServerOptions`](WDX.Schema.Model.Instance.APIServerOptions.md)

#### Defined in

src/WDX/Schema/Model/Instance/APIServerInstance.ts:19
...
src/WDX/Schema/Model/Instance/APIServerInstance.ts:21
...
src/WDX/Schema/Model/Instance/APIServerInstance.ts:17
...
• **type**: [`Type`](../enums/WDX.Schema.Model.Instance.Type.md) = `Type.APIServer`
...
src/WDX/Schema/Model/Instance/APIServerInstance.ts:15
