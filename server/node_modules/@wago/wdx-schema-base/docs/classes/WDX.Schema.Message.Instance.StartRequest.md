[@wago/wdx-schema-base](../README.md) / [Exports](../modules.md) / [WDX](../modules/WDX.md) / [Schema](../modules/WDX.Schema.md) / [Message](../modules/WDX.Schema.Message.md) / [Instance](../modules/WDX.Schema.Message.Instance.md) / StartRequest
...
- [timezone](WDX.Schema.Message.Instance.StartRequest.md#timezone)
...
• **new StartRequest**(`body?`, `uuid?`, `error?`, `topic?`, `target?`, `origin?`, `timezone?`): [`StartRequest`](WDX.Schema.Message.Instance.StartRequest.md)
...
src/WDX/Schema/Message/Instance/StartRequest.ts:20
...
src/WDX/Schema/Message/Instance/StartRequest.ts:15
