[@wago/wdx-schema-base](../README.md) / [Exports](../modules.md) / [WDX](../modules/WDX.md) / [Schema](../modules/WDX.Schema.md) / [Message](../modules/WDX.Schema.Message.md) / [Instance](../modules/WDX.Schema.Message.Instance.md) / StopRequest
...
- [timezone](WDX.Schema.Message.Instance.StopRequest.md#timezone)
...
• **new StopRequest**(`body?`, `uuid?`, `error?`, `topic?`, `target?`, `origin?`, `timezone?`): [`StopRequest`](WDX.Schema.Message.Instance.StopRequest.md)
...
src/WDX/Schema/Message/Instance/StopRequest.ts:19
...
src/WDX/Schema/Message/Instance/StopRequest.ts:14
