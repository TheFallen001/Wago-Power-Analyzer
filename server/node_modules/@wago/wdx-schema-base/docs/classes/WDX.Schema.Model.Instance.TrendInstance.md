[@wago/wdx-schema-base](../README.md) / [Exports](../modules.md) / [WDX](../modules/WDX.md) / [Schema](../modules/WDX.Schema.md) / [Model](../modules/WDX.Schema.Model.md) / [Instance](../modules/WDX.Schema.Model.Instance.md) / TrendInstance
...
- [id](WDX.Schema.Model.Instance.TrendInstance.md#id)
- [ipcType](WDX.Schema.Model.Instance.TrendInstance.md#ipctype)
...
- [needsRestart](WDX.Schema.Model.Instance.TrendInstance.md#needsrestart)
- [order](WDX.Schema.Model.Instance.TrendInstance.md#order)
...
- [startTime](WDX.Schema.Model.Instance.TrendInstance.md#starttime)
- [status](WDX.Schema.Model.Instance.TrendInstance.md#status)
- [stopTime](WDX.Schema.Model.Instance.TrendInstance.md#stoptime)
...
- [type](WDX.Schema.Model.Instance.TrendInstance.md#type)
...
• **new TrendInstance**(): [`TrendInstance`](WDX.Schema.Model.Instance.TrendInstance.md)
...
src/WDX/Schema/Model/Instance/TrendInstance.ts:14
...
• **executionOptions**: [`TrendExecutionOptions`](WDX.Schema.Model.Instance.TrendExecutionOptions.md)
...
src/WDX/Schema/Model/Instance/TrendInstance.ts:18
...
src/WDX/Schema/Model/Instance/TrendInstance.ts:16
...
src/WDX/Schema/Model/Instance/Instance.ts:23
