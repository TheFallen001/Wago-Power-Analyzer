[@wago/wdx-schema-base](../README.md) / [Exports](../modules.md) / [WDX](../modules/WDX.md) / [Schema](../modules/WDX.Schema.md) / [Message](../modules/WDX.Schema.Message.md) / [Instance](../modules/WDX.Schema.Message.Instance.md) / LogUnsubscribeRequestMessage
...
- [timezone](WDX.Schema.Message.Instance.LogUnsubscribeRequestMessage.md#timezone)
...
• **new LogUnsubscribeRequestMessage**(`body?`, `uuid?`, `error?`, `topic?`, `target?`, `origin?`, `timezone?`): [`LogUnsubscribeRequestMessage`](WDX.Schema.Message.Instance.LogUnsubscribeRequestMessage.md)
...
src/WDX/Schema/Message/Instance/LogUnsubscribeRequestMessage.ts:18
...
src/WDX/Schema/Message/Instance/LogUnsubscribeRequestMessage.ts:13
