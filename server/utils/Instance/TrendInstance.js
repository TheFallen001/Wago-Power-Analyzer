...
exports.TrendInstance = void 0;
var Type_1 = require("./Type");
var Instance_1 = require("./Instance");
var TrendInstance = /** @class */ (function (_super) {
    __extends(TrendInstance, _super);
    function TrendInstance() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.code = Type_1.Type.Trend;
        _this.namespace = Type_1.Type.Controller;
        return _this;
    }
    return TrendInstance;
}(Instance_1.Instance));
exports.TrendInstance = TrendInstance;
