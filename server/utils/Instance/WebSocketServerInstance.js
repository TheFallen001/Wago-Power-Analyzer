...
var WebSocketServerInstance = /** @class */ (function (_super) {
    __extends(WebSocketServerInstance, _super);
    function WebSocketServerInstance() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.code = Type_1.Type.WebSocketServer;
        _this.namespace = Type_1.Type.Controller;
        _this.executionOptions = new WebSocketServerExecutionOptions_1.WebSocketServerExecutionOptions();
        return _this;
    }
